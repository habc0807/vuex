...
ModuleCollection.prototype.register = function register (path, rawModule, runtime) {
  ...
  debugger
  var newModule = new Module(rawModule, runtime); //todo 返回值
  if (path.length === 0) {
    this.root = newModule;
  } else {
...
var Store = function Store (options) {
  ...
  this._modules = new ModuleCollection(options); // todo
  this._modulesNamespaceMap = Object.create(null);
  this._subscribers = [];
  this._watcherVM = new Vue(); // 干嘛用的 todo
  this._makeLocalGettersCache = Object.create(null); // getter缓存 todo
